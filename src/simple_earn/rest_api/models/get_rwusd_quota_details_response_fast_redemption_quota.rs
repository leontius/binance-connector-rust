...
pub struct GetRwusdQuotaDetailsResponseFastRedemptionQuota {
    ...
    #[serde(rename = "freeQuota", skip_serializing_if = "Option::is_none")]
    pub free_quota: Option<String>,
}

impl GetRwusdQuotaDetailsResponseFastRedemptionQuota {
    #[must_use]
    pub fn new() -> GetRwusdQuotaDetailsResponseFastRedemptionQuota {
